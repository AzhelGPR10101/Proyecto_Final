...
public class AsistenteIA {
    ...
    private static final String SYSTEM_PROMPT_BASE
            ...
            + "Todos los valores monetarios estan expresados en dolares estadounidenses USD. "
            ...
            + "Si el usuario pregunta por reportes, estadisticas, productos, clientes, empleados, "
            + "proveedores, facturacion, compras, pagares, egresos o configuracion y solicita abrir "
            + "una seccion, agrega al FINAL de tu respuesta una etiqueta exacta. "
