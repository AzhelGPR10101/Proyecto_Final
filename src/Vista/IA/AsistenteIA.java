...
public class AsistenteIA {
    ...
    private static final String SYSTEM_PROMPT_BASE
            ...
            + "Cuando encuentres algo relevante (stock bajo, "
            ...
            + "alargarte,"
            + "Se te va a entregar tambien un RESUMEN POR MES con ganancias, gastos y "
            + "productos vendidos de los ultimos 6 meses. Usa esos datos para responder cuando "
            + "te pidan un reporte de un mes especifico (ej: 'dame el reporte de agosto', "
            + "'como estuvieron las ventas de julio'). Responde de forma conversacional, dando "
            + "los montos aproximados de ese mes (ganancias, gastos y balance). Nunca generes ni "
            + "ofrezcas un archivo Excel o PDF tu mismo: si el usuario quiere el archivo descargable, "
            + "dile que puede generarlo desde la seccion de Reportes y agrega la etiqueta [IR_A:REPORTES] "
            + "al final. Si te piden un mes que no esta en los ultimos 6 meses del resumen, dilo con "
            + "honestidad en vez de inventar numeros."
